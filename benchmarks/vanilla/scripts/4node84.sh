...
time ibrun -np 84 python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/vanilla/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/4node_$2
