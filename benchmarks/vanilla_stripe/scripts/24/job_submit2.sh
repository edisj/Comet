...
do
    ...
    sbatch /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/vanilla_stripe/scripts/24/copy_file.sh /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/vanilla_stripe/scripts/24/6node132.sh $1 $repeat
done
