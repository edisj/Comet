...
time ibrun -np 24 python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/mask_and_memory/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/1node_$2
