...
#SBATCH -t 03:30:00   # time in hh:mm:ss
...
time ibrun -np 1 python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/Khosh_comparison_masked/scripts/benchmark.py $testdir/small_top.pdb $testdir/xtc600x.h5md $1/1node_$2
