...
time ibrun -np 24 python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/Khosh_comparison_masked/scripts/benchmark.py $testdir/adk4AKE.psf $testdir/xtc600x.h5md $1/1node_$2
