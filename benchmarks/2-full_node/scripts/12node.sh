...
for j in 1 2 3
do
    ibrun -np 288 python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/2-full_node/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/12node_$j
done
