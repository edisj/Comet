...
do
    ...
    #sbatch /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/h5py_stripe/scripts/copy_file.sh /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/h5py_stripe/scripts/6node144.sh $1 $repeat
