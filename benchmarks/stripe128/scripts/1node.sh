...
do
    ...
    do
        ...
        time ibrun -np $i python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/stripe128/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/1node_$j
    done
done
