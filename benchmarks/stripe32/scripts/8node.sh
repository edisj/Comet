...
do
    ...
    time ibrun -np 192 python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/stripe32/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/8node_$j
done
