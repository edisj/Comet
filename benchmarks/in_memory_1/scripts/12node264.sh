...
time ibrun -np 264 python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/in_memory_1/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/12node_$2
