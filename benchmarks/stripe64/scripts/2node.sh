...
do
    ...
    time ibrun -np 48 python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/stripe64/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/2node_$j
done
