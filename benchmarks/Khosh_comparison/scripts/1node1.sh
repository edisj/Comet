...
time ibrun -np 1 python -W ignore /oasis/projects/nsf/azs119/edisj/Comet/benchmarks/Khosh_comparison/scripts/benchmark.py $testdir/small_top.pdb $testdir/small_traj.h5md $1/1node_$2
