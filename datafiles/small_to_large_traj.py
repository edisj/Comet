...
def main():
    top = '/oasis/projects/nsf/azs119/edisj/Comet/datafiles/small_top.pdb'
    traj = '/oasis/projects/nsf/azs119/edisj/Comet/datafiles/small_traj.h5md'

    u = mda.Universe(top, traj)
    create_test_trj(u, '/oasis/projects/nsf/azs119/edisj/Comet/datafiles/large_traj.h5md')
